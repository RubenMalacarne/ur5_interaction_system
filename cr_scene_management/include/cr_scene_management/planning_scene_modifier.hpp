...
#include <cr_interfaces/msg/object_detection_result.hpp>
...
namespace scene_management {
    ...
    private:
        ...
        void spawnObjects(const cr_interfaces::msg::ObjectDetectionResult::SharedPtr detected_objects);
        ...
        rclcpp::Subscription<cr_interfaces::msg::ObjectDetectionResult>::SharedPtr obj_detection_result_sub_;
