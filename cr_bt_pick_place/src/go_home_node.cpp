...
{
    // Retrieve shared ROS node and MotionCommander from blackboard
...
NodeStatus GoHomeNode::onStart()
{
    ...
    // Trigger go_home motion
    RCLCPP_INFO(nh_->get_logger(), "%s: Requesting to go home...", name().c_str());
